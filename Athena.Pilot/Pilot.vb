...
Public Module Pilot
    ...
    Public Function StartCalculation(X2 As Array, Constrained As Boolean) As (DistanceScore As Double, PayloadScore As Double, AltitudeScore As Double, BonusTakeOff As Double, Failed As Boolean)
